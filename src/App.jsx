...
function App() {
  return (
    <div>
      ...
      <p>{list[1].name}</p>
      <p>{list[2].name}</p>
      <p>Company: {complex[0].company}</p>
      <p>Jobs: {complex[0].jobs}</p>
      <p>Company: {complex[1].company}</p>
      <p>Jobs: {complex[1].jobs}</p>
      {/* For example, say you have 3 modules in one file, and you export them as
      export A; export B; export C;. You can then import any one of them using
      the curly brackets import syntax. So import {(A, B)}, for example will
      import module A and B only. */}
      <table border="2">
        <tr>
          <th>UserId</th>
          <th>id</th>
